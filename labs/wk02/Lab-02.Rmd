...
## Introduction
Chapter 1 demonstrates how to access the Longitudinal Tract Data Base (LTDB) data dictionary. Three functions provide the ability to filter the large number of LTDB variables to select only those with a certain category title, where the description field contains a specified text string, or from a specific year.
...
```{r}
# test function 2, filtering for word "race" in description text
